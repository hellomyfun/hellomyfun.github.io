...
(function () {
    ...
    CreatshoppingView.prototype.cartView = function (info,superView) {
        ...
        var p = $("<p class='cartContext'><input type='checkbox' ><img src="+goodsListImg+"><span>"+goodsName+"</span><span class='price'>"+"￥"+price+"</span><input class='num' value='1' min='1' type='number'><span class='price price2'>"+"￥"+price+"</span><button class='button'>删除</button><span>"+"总计："+price+"</span><a href='#' class='play'>去付款</a></p>");
